## The functions allow  to create a cached version of an inversed ("solved") matrix

## The function sets the value of the matrix and gets the value of the inverse  
